...
public class UserMng {
    ...
    public static void ShowPage() {
        ...
        String[] titles = new String[]{"Id", "Role", "Username", "Fullname", "Phone", "Email"};
        List<User> user_list = User.listAllUser(Main.userdata_file);
        Object[][] data = new Object[user_list.size() * 6][titles.length];
        int counter = 0;
        ...
        scrollPane1 = new CustomComponents.CustomScrollPane(false, 1, table_user,
