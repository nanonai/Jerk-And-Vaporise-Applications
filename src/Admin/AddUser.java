    ...
    public static int[] ShowPage(int filter) {
        ...
        password.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if (!User.passwordChecker(input) && !input.isEmpty()) {
                    ...
                    password.setToolTipText("Password must contains at least one \n" +
                    ...
                    attributes.put(TextAttribute.UNDERLINE, TextAttribute.UNDERLINE_ON);
                    password.setFont(font.deriveFont(attributes));
                    password.setToolTipText("Password length must be more than 8.");
                }
            }
        });
        ...
        confirm.addActionListener(_ -> {
            if (username.getText().isEmpty() || fullname.getText().isEmpty() || password.getText().isEmpty() ||
                ...
                String validity = User.validityChecker(username.getText(), password.getText(), fullname.getText(),
                        email.getText(), phone.getText(), Main.userdata_file);
//                0X000X0X
