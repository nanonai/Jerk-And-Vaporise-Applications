...
public class InventoryPage {
    ...
    public  static void ShowPage(){
        ...
        String[] titles = new String[]{"ItemID", "ItemName", "UnitPrice","Quantity","Threshold","Category","LastUpdateDate", "SupplierID"};
        List<Item> item_list = Item.listAllItem(Main.item_file);
        Object[][] data = new Object[item_list.size() ][titles.length];
        int counter = 0;
        for (Item item : item_list) {
            data[counter] = new Object[]{item.itemID,item.itemName, item.unitPrice,item.quantity,item.threshold,item.category,
                    item.lastUpdateDate, item.supplierID};
            counter += 1;
        }
        ...
        viewInventory = new CustomComponents.CustomButton("View Item", merriweather, new Color(255, 255, 255),
