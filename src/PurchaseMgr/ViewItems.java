...
public class ViewItems {
    ...
    static CustomComponents.CustomTable table_item;
    ...
    public static void ShowPage() {
        ...
        for (Item item : item_list) {
            data[counter] = new Object[]{item.ItemID, item.ItemName, item.UnitPrice,
                    item.UnitCost, item.StockCount, item.Threshold, item.Category};
            counter += 1;
        }
        ...
        add.addActionListener(_ -> {
            if (table_item.getSelectedRowCount() == 0) {
                ...
                ItemDetails.UpdateItem(Item.getItemByID(selected_id, Main.item_file));
    ...
    public static void SearchStuff() {
        ...
        List<Item> temp_user_list = Item.listAllItem(Main.item_file);
