...
public class PurchaseOrderMng {
    ...
    public static void Loader(JFrame parent, Font merriweather, Font boldonse, JPanel content, User current_user) {
        PurchaseOrderMng.parent = parent;
        PurchaseOrderMng.merriweather = merriweather;
        PurchaseOrderMng.boldonse = boldonse;
        PurchaseOrderMng.content = content;
        PurchaseOrderMng.current_user = current_user;
    }
