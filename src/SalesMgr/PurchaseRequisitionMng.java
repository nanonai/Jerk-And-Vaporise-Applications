...
public class PurchaseRequisitionMng {
    ...
    private static CustomComponents.CustomTable table_pr;
    ...
    public static void Loader(JFrame parent, Font merriweather, Font boldonse, JPanel content, User current_user) {
        PurchaseRequisitionMng.parent = parent;
        PurchaseRequisitionMng.merriweather = merriweather;
        PurchaseRequisitionMng.boldonse = boldonse;
        PurchaseRequisitionMng.content = content;
        PurchaseRequisitionMng.current_user = current_user;
    }
        ...
        add2.addActionListener(_ -> {
            if (table_pr.getSelectedRowCount() == 0) {
                ...
                if ("0".equalsIgnoreCase(status)) {
                    ...
                    CustomComponents.CustomOptionPane.showErrorDialog(
                            parent,
                            "This Purchase Requisition has been Generated. Cannot edit.",
                            "Cannot Edit",
                            new Color(209, 88, 128),
                            new Color(255, 255, 255),
                            new Color(237, 136, 172),
        ...
        delete1.addActionListener(_ -> {
            if (table_pr.getSelectedRowCount() > 0){
                ...
                if ("1".equalsIgnoreCase(status)) {
                    CustomComponents.CustomOptionPane.showErrorDialog(
                            parent,
                            "This Purchase Requisition has been generated and cannot be deleted.",
                            "Cannot Delete",
                            new Color(209, 88, 128),
                            new Color(255, 255, 255),
                            new Color(237, 136, 172),
                ...
                int confirm = JOptionPane.showConfirmDialog(parent, "Are you sure you want to delete PurchaseReqID: " + selectedPRID + "?",
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                if (line.startsWith("PurchaseReqID")) {
                    String currentPRID = line.split(":")[1].trim();
                    poFound = currentPRID.equals(prID);
    ...
    public static void deletePurchaseRequisition(String purchaseReqId, String filename) {
        try {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (line.trim().startsWith("PurchaseReqID")) {
                    ...
                    if (parts.length > 1 && parts[1].trim().equals(purchaseReqId)) {
                        skipBlock = true;
                    } else {
                        skipBlock = false;
                    }
            ...
            CustomComponents.CustomOptionPane.showErrorDialog(
                    parent,
                    "Purchase requisition " + purchaseReqId + " deleted successfully.",
                    "",
                    new Color(209, 88, 128),
                    new Color(255, 255, 255),
                    new Color(237, 136, 172),
